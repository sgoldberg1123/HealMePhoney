...
public class PedometerInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int tStep = 2000;
//        try {
//            tStep = getCurrentStep("2017-05-08");
...
//        }
        ...
        String tCal = String.format( "%.2f", tStep*50*0.00001578*350*0.57 );
...
//        } catch (Exception ex) {
//        }
        String yStepCount = String.format(getString(R.string.y_info_2), String.valueOf(yStep));
        ySteps.setText(yStepCount);

        TextView bSteps = (TextView) findViewById(R.id.btxt2);
        int bStep = 3000;
//        try {
//            tStep = getCurrentStep("2017-05-08");
//            System.out.println(tStep);
//        } catch (Exception ex) {
//        }
        String bStepCount = String.format(getString(R.string.b_info_2), String.valueOf(bStep));
        bSteps.setText(bStepCount);

        TextView cSteps = (TextView) findViewById(R.id.ctxt2);
        int cStep = 10000000;
//        try {
//            tStep = getCurrentStep("2017-05-08");
//            System.out.println(tStep);
//        } catch (Exception ex) {
//        }
        String cStepCount = String.format(getString(R.string.c_info_2), String.valueOf(cStep));
        cSteps.setText(cStepCount);
